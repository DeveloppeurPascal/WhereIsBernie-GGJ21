...
Download the official GGJ21 sources and programs to play from the game page: https://globalgamejam.org/2021/games/where-bernie-4

This code repository will evolve as the game evolves, unlike the elements published on the Global Game Jam website.

The development of this game took place live on Twitch throughout the jam weekend. Video replays are available on the website https://serialstreameur.fr/jv-where-is-bernie.php, where you can also find replays of all my video presentations (conferences, presentations, webinars, live coding, and game coding).

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the "Where Is Bernie ?" website](https://whereisbernie.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/WhereIsBernie-GGJ21) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://whereisbernie.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/where-is-bernie.html).
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://whereisbernie.gamolf.fr).
